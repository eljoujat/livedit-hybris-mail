 ...
 *  
 */
package org.yoceflab.hybris.mailpreview.jalo;
...
import org.yoceflab.hybris.mailpreview.constants.MailpreviewConstants;


/**
 * This is the extension manager of the Ybackoffice extension.
 */
public class MailpreviewManager extends GeneratedMailpreviewManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(MailpreviewManager.class.getName());
	 ...
	 */
	public static MailpreviewManager getInstance()
	{
		return (MailpreviewManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(MailpreviewConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public MailpreviewManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of MailpreviewManager called.");
		}
	}
